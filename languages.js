...
if( obj.tagName == "OBJECT" || obj.tagName == "SCRIPT" || obj.tagName == "EMBED" )continue;
	...
	//	{
			//obj.src = obj.src.replace('csg_1', 'csg_2');
	//	}
		else 
			translateBody(obj);
...
function translatePage()
{
 ...
 function FTJ(){
     ...
     for(var i=0;i<tag_img.length;i++){
          var obj=tag_img[i];
          var src=tag_img[i].src;
          obj.src=src.replace('csg_big5','csg_gb');
          //alert(tag_img[i].src);
     }

  // document.body.innerHTML = document.body.innerHTML.replace('csg_1', 'csg_2');
 //  alert("replace('big5', 'gb')");
 }
 ...
 function JTF(){
     ...
     for(var i=0;i<tag_img.length;i++){
          var obj=tag_img[i];
          var src=tag_img[i].src;
          obj.src=src.replace('csg_gb','csg_big5');
          //alert(tag_img[i].src);
     }

    //document.body.innerHTML = document.body.innerHTML.replace('csg_2', 'csg_1');
  //  alert("replace('gb', 'big5')");
 }
...
function translateInitilization()
{
	...
	//alert("currentEncoding = " + currentEncoding);
		...
		if ( currentEncoding != targetEncoding ) 
		{
			...
			if( targetEncoding == 1 )
			{
				...
				JTF();
			//	alert("targetEncoding = " + targetEncoding);
			}
			else
			{ 
